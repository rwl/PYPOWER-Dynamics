...
def case9():
    ...
    ppc["gen"] = array([
        [1, 0,   0, 300, -300, 1.04, 100, 1, 250, 10, 0.01, 0.12, 0, 0, 0, 0, 0, 0, 0, 0, 0],
        [2, 163, 0, 300, -300, 1.025, 100, 1, 300, 10, 0.01, 0.16, 0, 0, 0, 0, 0, 0, 0, 0, 0],
        [3, 85,  0, 300, -300, 1.025, 100, 1, 270, 10, 0.005, 0.10, 0, 0, 0, 0, 0, 0, 0, 0, 0]
    ])

    ## branch data
    # fbus, tbus, r, x, b, rateA, rateB, rateC, ratio, angle, status, angmin, angmax
    ppc["branch"] = array([
        [1, 4, 0.02,      0.0576, 0,     250, 250, 250, 0, 0, 1, -360, 360],
        [4, 6, 0.017,  0.092,  0.158, 250, 250, 250, 0, 0, 1, -360, 360],
        [6, 9, 0.039,  0.17,   0.358, 150, 150, 150, 0, 0, 1, -360, 360],
        [3, 9, 0.02,      0.0586, 0,     300, 300, 300, 0, 0, 1, -360, 360],
        [8, 9, 0.0119, 0.1008, 0.209, 150, 150, 150, 0, 0, 1, -360, 360],
        [7, 8, 0.0085, 0.072,  0.149, 250, 250, 250, 0, 0, 1, -360, 360],
        [7, 2, 0.025,      0.0625, 0,     250, 250, 250, 0, 0, 1, -360, 360],
